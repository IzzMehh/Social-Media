  ...
  return(
    <div className='text-white w-full h-full border-r-2'>
      <div className='w-full h-full grid  justify-center  grid-rows-[100px,100px,100px,100px,auto]'>
        ...
        <NavLink to="/about" className={({isActive})=>(`${isActive ? 'bg-blue-700' : 'bg-blue-500'} flex justify-center items-center w-[150px] h-[60px] rounded-full mb-2`)}><ion-icon name="code-slash"></ion-icon><span className='ml-2'> About</span></NavLink>
        <button onClick={fn} className="flex justify-center items-center w-[150px] h-[60px] bg-blue-500 rounded-full mb-2">Post </button>
